                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        LearnCard(
                            ...
                            bodyText: "Nobody finishes a beer in one second. SipTrack knows that — so when you log a drink, it treats the moment you tap \"add\" as when you started drinking it, not when you finished.\n\nEach drink type has a built-in sipping time based on how people actually consume it:\n\n• Beer / hard seltzer — ~20 minutes\n• IPA — ~25 minutes\n• Wine / champagne — ~30 minutes\n• Cocktails — ~25 minutes\n• Shots (tequila, vodka, mezcal) — ~1 minute\n• Whiskey — ~5 minutes\n\nDuring that window, your BAC rises gradually as your body absorbs the alcohol. Log your next drink before the window is up and SipTrack uses the gap between drinks as the duration instead — your next tap is the signal that the previous drink is done.\n\nYou can change any drink's estimated sipping time in your profile. Everyone drinks at their own pace, and the number you set is what the model uses.",
                            sources: [
