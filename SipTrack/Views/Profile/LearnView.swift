                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        LearnCard(
                            ...
                            title: "How Tracksip estimates your BAC",
                            bodyText: "Tracksip uses the Widmark framework — the forensic standard since 1932 — extended with modern pharmacokinetic refinements that improve accuracy over a vanilla Widmark calculator.\n\nThe baseline equation:\n\nBAC = (A ÷ (W × r)) − (β × t)\n\n• A — grams of pure alcohol consumed (volume × ABV × 0.789)\n• W — body weight in kilograms\n• r — distribution ratio (how much body water the alcohol spreads through)\n• β — elimination rate (how fast your liver clears alcohol)\n• t — hours since drinking started\n\nWhat Tracksip adds on top of the textbook formula:\n\n1. Watson 1980 total-body-water individualisation of r when you've entered your height and birth year. This is more accurate than the population constants 0.68 (men) / 0.55 (women) for people outside the average BMI.\n\n2. Sex-specific β — women clear alcohol about 14% faster than men in the elimination phase (0.0157 vs 0.0138 BAC% / h), measured directly in modern breath-alcohol studies.\n\n3. First-order absorption — alcohol doesn't appear in your blood instantly. Tracksip models the rising curve with an absorption rate constant kA that depends on what's in your stomach.\n\n4. First-pass metabolism — when you eat with alcohol, gastric alcohol dehydrogenase oxidises part of the dose before it reaches your bloodstream. Tracksip subtracts this fraction (10% for a snack, 20% for a full meal, halved for women who have less gastric ADH).\n\n5. Age correction — β decreases about 5% per decade after 60.",
                            sources: [
                        ...
                        LearnCard(
                            ...
                            title: "How your drinking pace shapes your BAC",
                            bodyText: "Nobody finishes a beer in one second. Tracksip knows that — so when you log a drink, it treats the moment you tap \"add\" as when you started drinking it, not when you finished.\n\nEach drink type has a built-in sipping time based on how people actually consume it:\n\n• Beer / hard seltzer — ~20 minutes\n• IPA — ~25 minutes\n• Wine / champagne — ~30 minutes\n• Cocktails — ~25 minutes\n• Shots (tequila, vodka, mezcal) — ~1 minute\n• Whiskey — ~5 minutes\n\nDuring that window, your BAC rises gradually as your body absorbs the alcohol. Log your next drink before the window is up and Tracksip uses the gap between drinks as the duration instead — your next tap is the signal that the previous drink is done.\n\nYou can change any drink's estimated sipping time in your profile. Everyone drinks at their own pace, and the number you set is what the model uses.",
                            sources: [
                                ("Jones 1996 — Pharmacokinetics of ethanol", "https://pmc.ncbi.nlm.nih.gov/articles/PMC1727307/"),
                                ("Norberg 2003 — Clinical pharmacokinetics of alcohol", "https://link.springer.com/article/10.2165/00003088-198713050-00001"),
                                ("Searle 2015 — Widmark model accuracy", "https://pmc.ncbi.nlm.nih.gov/articles/PMC4361698/"),
                            ]
                        )
        ...
        HStack(alignment: .top, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Not medical advice")
                    .font(.system(size: 12, weight: .semibold))
                    .foregroundStyle(AppColors.textSecondary)
                Text("Tracksip's BAC estimates are approximations based on mathematical models. Individual physiology varies. Never rely solely on this app to determine if you are safe to drive. If in doubt, don't drive.")
                    .font(.system(size: 11))
                    .foregroundStyle(AppColors.textTertiary)
                    .lineSpacing(3)
                    .fixedSize(horizontal: false, vertical: true)
